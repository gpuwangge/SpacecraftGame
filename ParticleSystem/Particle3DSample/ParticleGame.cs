...
namespace Particle3D
{
    ...
    public class Particle3DSampleGame : Microsoft.Xna.Framework.Game
    {
        ...
        public Particle3DSampleGame()
        {
            ...
            smokeParticleSystem = new SmokeParticleSystem(this, Content, 10, Color.White, 5f);
            fireParticleSystem = new FireParticleSystem(this, Content, 10, Color.White);
            explosionSmokeParticleSystem = new ExplosionSmokeParticleSystem(this, Content, 10, Color.White);
            explosionParticleSystem = new ExplosionParticleSystem(this, Content, 100, Color.White);
        ...
        {
          //  smokeParticleSystem.AddParticle(Vector3.Zero, new Vector3(0, 0, -100));
          // fireParticleSystem.AddParticle(Vector3.Zero, new Vector3(0, 0, -100));
            explosionParticleSystem.AddParticle(Vector3.Zero, new Vector3(0, 0, 0));
            //explosionSmokeParticleSystem.AddParticle(Vector3.Zero, new Vector3(0, 0, 0));
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            smokeParticleSystem.SetCamera(view, projection);
            fireParticleSystem.SetCamera(view, projection);
